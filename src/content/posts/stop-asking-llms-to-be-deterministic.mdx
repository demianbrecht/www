...
draft: false
heroImage: ../../assets/posts/stop-asking-llms-to-be-deterministic-v2.png
heroImageAlt: 'A turbulent cyan energy core contained inside a precise industrial machine with fixed output channels'
---
